/**
 * Product Data Validation Script (JSON version)
 * 
 * This script validates the product data structure from the extracted JSON file
 */

const fs = require('fs');
const path = require('path');

// First run process_products.js if the JSON file doesn't exist
const jsonFilePath = path.join(__dirname, 'products_temp.json');
if (!fs.existsSync(jsonFilePath)) {
  console.error('Products JSON file not found. Please run process_products.js first.');
  process.exit(1);
}
