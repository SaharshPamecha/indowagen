        ...
        <Container maxWidth="lg">
          ...
          >
            ...
            >
              ...
              >
                Indo Wagen offers a wide range of electric three-wheelers, from
                passenger e-rickshaws to cargo loaders, designed to deliver high
                performance, durability, and cost-effectiveness. Our
                state-of-the-art ICAT-approved vehicles are built for
                efficiency, offering low maintenance and high mileage, making
                them an ideal choice for urban and rural transport.
              </Typography>
              <Box sx={{ textAlign: { xs: "center", md: "left" }, mt: 3 }}>
                <Button
                  ...
                  component={Link} // Add button animation
